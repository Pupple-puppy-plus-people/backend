...
from . import views
from .views import get_dog_customer_matched_photo_view, updatephoto_view, getphoto_view, get_all_mydog_photo_view,get_one_dog_photo_view, update_house_photo_pass
app_name = "housephoto"
urlpatterns = [
    ...
    path('update/pass/', update_house_photo_pass, name='update_house_photo_pass'),
